...
(function(explorerError) {
	...
	explorerError['ERROR_1005'] =
		'Platform implementation is not found for synch process %s';
	explorerError['ERROR_1006'] =
		'Platform type is not found in syncconfig or argument';
	explorerError['ERROR_1007'] =
		'Missing network_name and client_name , Please run as > sync.js network_name client_name';
	explorerError['ERROR_1008'] =
	...
	explorerError['ERROR_2008'] =
		'There is no client found for Hyperledger fabric platform';
	explorerError['ERROR_2009'] =
		'Explorer is closing due to channel name [%s] is already exist in DB';
	explorerError['ERROR_2010'] = 'Client Processor Error >> %s';
	explorerError['ERROR_2011'] =
		'There is no client found for Hyperledger fabric scanner';
	explorerError['ERROR_2013'] =
		'Channel name [%s] already exist in DB , Kindly re-run the DB scripts to proceed';
	explorerError['ERROR_2014'] =
		'Invalid platform configuration, Please check the log';
	explorerError['ERROR_2015'] =
		'Invalid network configuration, Please check the log';
	// Generic Message
	explorerError['MESSAGE_1001'] =
		'Explorer will continue working with only DB data';
