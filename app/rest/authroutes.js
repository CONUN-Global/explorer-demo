...
var logger = helper_1.helper.getLogger('Auth');
/**
 *
 *
 * @param {*} router
				...
				requestutils_1.responder(function(req) {
					return __awaiter(_this, void 0, void 0, function() {
						...
						return __generator(this, function(_a) {
							switch (_a.label) {
								case 0:
									return [4 /*yield*/, proxy.networkList(req)];
								case 1:
									networkList = _a.sent();
									return [2 /*return*/, { networkList: networkList }];
							}
						});
					});
				})
			...
			router.post('/login', function(req, res, next) {
				return __awaiter(_this, void 0, void 0, function() {
					return __generator(this, function(_a) {
						...
						return [
							2 /*return*/,
							passport_1['default'].authenticate('local-login', function(
								err,
								token,
								userData
							) {
