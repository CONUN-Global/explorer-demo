...
var ForkListenerHandler_1 = require('./ForkListenerHandler');
/**
 *
 *
 * @class ExplorerListener
 */
var ExplorerListener = /** @class */ (function() {
	/**
	 ...
	 */
	function ExplorerListener(platform, syncconfig) {
	 ...
	 * @memberof ExplorerListener
	 */
	ExplorerListener.prototype.initialize = function(args) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				if (
					this.syncType &&
					this.syncType === ExplorerConst_1.explorerConst.SYNC_TYPE_LOCAL
				) {
					this.syncListenerHandler = new ForkListenerHandler_1.ForkListenerHandler(
						this.platform
					);
				}
	 ...
	 * @memberof ExplorerListener
	 */
	ExplorerListener.prototype.send = function(message) {
		if (this.syncListenerHandler) {
	 ...
	 *
	 */
	ExplorerListener.prototype.close = function() {
		if (this.syncListenerHandler) {
