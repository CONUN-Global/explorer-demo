...
var Persist_1 = require('./postgreSQL/Persist');
/**
 *
 *
 * @class PersistenceFactory
 */
var PersistenceFactory = /** @class */ (function() {
	 ...
	 */
	PersistenceFactory.create = function(db, dbconfig) {
				...
				switch (_a.label) {
					case 0:
						if (!(db === ExplorerConst_1.explorerConst.PERSISTENCE_POSTGRESQL))
							return [3 /*break*/, 2];
						persistence = new Persist_1.Persist(dbconfig);
						return [4 /*yield*/, persistence.getPGService().handleDisconnect()];
					case 1:
						_a.sent();
						return [2 /*return*/, persistence];
					case 2:
						throw new ExplorerError_1.ExplorerError(
							ExplorerMessage_1.explorerError.ERROR_1003,
							db
						);
				}
			});
