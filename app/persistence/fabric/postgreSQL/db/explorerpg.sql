...
-- CREATE USER :conun
-- WITH PASSWORD :conun1234;
-- DROP DATABASE IF EXISTS :fabricexplorer;
-- CREATE DATABASE :fabricexplorer owner :conun;
-- \c :fabricexplorer;
-- --
...
ALTER table blocks owner to :conun;
...
ALTER table chaincodes owner to :conun;
...
ALTER table peer_ref_chaincode owner to :conun;
...
ALTER table channel owner to :conun;
...
ALTER table peer owner to :conun;
-- ---------------------------
...
ALTER table peer_ref_channel owner to :conun;
...
ALTER table orderer owner to :conun;
...
ALTER table transactions owner to :conun;
Alter sequence transactions_id_seq restart with 6;

-- ---------------------------
--  Table structure for `conuns`
-- ----------------------------
...
ALTER table users owner to :conun;
...
ALTER table write_lock owner to :conun;
...
GRANT SELECT, INSERT, UPDATE,DELETE ON ALL TABLES IN SCHEMA PUBLIC to :conun;
