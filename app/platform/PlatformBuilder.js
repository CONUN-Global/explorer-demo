...
var Platform_1 = require('./fabric/Platform');
/**
 *
 *
...
var PlatformBuilder = /** @class */ (function() {
	 ...
	 */
	PlatformBuilder.build = function(pltfrm, persistence, broadcaster) {
		return __awaiter(this, void 0, void 0, function() {
			var platform;
			return __generator(this, function(_a) {
				if (pltfrm === ExplorerConst_1.explorerConst.PLATFORM_FABRIC) {
					platform = new Platform_1.Platform(persistence, broadcaster);
					return [2 /*return*/, platform];
				}
				throw new ExplorerError_1.ExplorerError(
					ExplorerMessage_1.explorerError.ERROR_1004,
					pltfrm
				);
			});
		});
