...
var logger = helper_1.helper.getLogger('User');
/**
 *
 *
 * @class User
...
var User = /** @class */ (function() {
	 ...
	 * @memberof User
	 */
	User.createInstanceWithParam = function(user, password, network, roles) {
		return new User({
			user: user,
			password: password,
			network: network,
