...
var requestutils_1 = require('../../../rest/requestutils');
/**
 *
 *
 * @param {*} router
...
function adminroutes(router, platform) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(_a) {
			...
			router.post(
				'/register',
				requestutils_1.responder(function(req) {
						...
						return __generator(this, function(_a) {
							switch (_a.label) {
								...
								case 1:
									...
									return [4 /*yield*/, proxy.register(reqUser)];
								case 2:
				...
				requestutils_1.responder(function(req) {
					return __awaiter(_this, void 0, void 0, function() {
						return __generator(this, function(_a) {
							switch (_a.label) {
								case 0:
									return [4 /*yield*/, proxy.userlist({ network: req.network })];
								case 1:
									return [2 /*return*/, _a.sent()];
							}
						});
						...
						return __generator(this, function(_a) {
							switch (_a.label) {
								...
								case 1:
									...
									reqUser.network = req.network;
									reqUser.requestUserId = req.requestUserId;
									return [4 /*yield*/, proxy.unregister(reqUser)];
								case 2:
									return [2 /*return*/, _a.sent()];
							}
						});
